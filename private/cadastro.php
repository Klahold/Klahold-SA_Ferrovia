...
<body>
    ...
    <div class="brancoGeral">
        <div class="arrastarGeral">
            ...
            <div class="cinzaCadastro">
                <input type="text" name="dataNascimento" id="dataNascimento" placeholder="Data De Nascimento:" class="input">
            </div>
            ...
            <div class="cinzaCadastro">
                <input type="text" name="cargo" id="cargo" placeholder="Cargo:" class="input">
            </div>
            ...
            <div class="cinzaCadastro">
                <input type="number" name="RG" id="RG" placeholder="RG:" class="input">
            </div>
            ...
            <div class="cinzaCadastro">
                <input type="text" name="dataAdmissão" id="dataAdmissão" placeholder="Data de Adimissão:" class="input">
            </div>
